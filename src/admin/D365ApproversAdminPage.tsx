...
import type { AdAccountDto, D365ApproverDto, D365ViewerDto } from '../api/types';
 ...
 * match anyone. Reused for both Approbateurs (scoped by an optional Position Title) and Personnel
 * TI (always global, view-only — no Position Title field at all). */
function usePicker(search: (q: string) => Promise<AdAccountDto[]>) {
...
function PickerField({ picker }: { picker: ReturnType<typeof usePicker> }) {
